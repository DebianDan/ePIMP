...
$selectQuery = 'SELECT count(1) as count from points inner join accounts on accounts.accounts_pk = points.accounts_fk where pgid=' . $safe_pgid .' and token = "' . $safe_token .'" and reason = "You made the right move."';
