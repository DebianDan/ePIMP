...
$con = mysql_connect(DB_HOST, DB_USER, DB_PASSWORD) or
    log("Could not connect: " . mysql_error(), true );
...
*/
log( 'Building adjascent map between users...');
...
*/
log( 'Getting how many open friendships each specific user...' );
...
mysql_close($con);
log( 'Finished running buildmap.php');
?>
